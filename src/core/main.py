...
def goal1_gab(obj_info):
    ...
    # 打印最终结果
    print("最终目标距离参数: " + str(x),str(real_y))
    print("------------")
...
if __name__ == '__main__':
    ...
    move.forward_trapezoidal(1.10,1.2,2.5)
...
######第一次    
    ...
    time.sleep(1)
    move.forward_trapezoidal(0.41,0.2,0.8)
    ...
    # move.backward_trapezoidal(0.05,0.15,1.5)
   ...
   #调整前后距离
    ...
    # 转身后退到放置位置
    move.right_trapezoidal(99.5, 0.8, 1.5)
    time.sleep(0.5)
...
# # # # 第二次
    ...
    for _ in range(2):  #8
        ...
        Sonor().sonor_control_goal_5()
    time.sleep(0.5)
    move.backward_trapezoidal(0.1, 0.4, 3)
    # move.moveback(0.05,0.5)
 ...
 # # # 第三次
    ...
    for _ in range(2):  #8
        ...
        Sonor().sonor_control_goal_5()
    move.backward_trapezoidal(0.17,0.08,0.5)
    # move.moveback(0.05,0.5)
    time.sleep(0.5)

    # 转身后退到放置位置
    move.right_trapezoidal(99.7, 0.8, 1.5)
    time.sleep(0.5)
    move.backward_trapezoidal(0.55, 0.4, 3)
...
# # # 第四次
    ...
    time.sleep(0.5)
    move.left_trapezoidal(98.23, 0.8, 1.5)
    move.forward_trapezoidal(0.23,0.05,1.5)
    ...
    # 调整前后距离
    move.backward_trapezoidal(0.06,0.04,0.8)
    ...
    time.sleep(0.5)
    #转身后退到放置位置
    move.right_trapezoidal(99.8, 0.8, 1.5)
    ...
    # time.sleep(0.5)
    move.right_trapezoidal(97, 1.4, 1.5)
    ...
    for _ in range(4):
        goal_6 = mobile_to_goal.read_goal("goal_6.txt")
        goal_number = 6
        print("坐标6_初始点接收完毕...")
        mobile_to_goal.send_goal(goal_number, goal_6)
        print("到达坐标6_初始点...")
        time.sleep(0.5)
        for _ in range(2):  
            distance = Sonor().get_sonor_data()
