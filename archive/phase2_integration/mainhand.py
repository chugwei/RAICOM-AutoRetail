...
def get_user_placement_choice(label, default_side):
    ...
    print("程序默认建议: {}".format('左侧 (A/C),输入1111111111111111111111111111111111111111111111111111111111111111111111111' if default_side == 1 else '右侧 (B/D),输入22222222222222222222222222222222222222222222222222222222222222222222222'))
