...
if __name__ == '__main__':
    ...
    while (cats_caught < 3 or birds_caught < 3) and attempts_left > 0:
        ...
        if label == "cat":
            ...
            #         print("抓近处")
            #         print("x,y")
            #         print(real_x + grabParams.x_near,real_y + grabParams.y_bias)
            #         print(grabParams.x_near,grabParams.height_near)
            #     else:
            #         detect.grab_move(real_x + grabParams.x_far - 4, real_y + grabParams.y_bias, grabParams.height_far)
            #         print("抓远处")
            #         print("x,y")
            #         print(real_x + grabParams.x_far,real_y + grabParams.y_bias)
