...
if grabParams.site == "left":
    ...
    time.sleep(1)
    #jiazhuahouyi
    mc.send_coord(Coord.Y.value, grabParams.coords_ready[1] - 10, 30) #  -18 -110
    mc.send_coords(grabParams.coords_ready3, 40, 0)
    # # 夹爪回到准备动作
    # mc.send_coords(grabParams.coords_ready, 40, 0)
    # # mc.send_coord(Coord.Y.value, -120, 20)
    time.sleep(1.5)
    mc.send_coords(grabParams.coords_ready2, 40, 0)
    # time.sleep(1.5)
    # # 夹爪下移
    # mc.send_coord(Coord.Z.value, grabParams.coords_ready[2] - 60, 50) # 260 90     mc.send_coord(Coord.Z.value, grabParams.coords_ready[2] - 110, 50)
    # time.sleep(1)
    # # 夹爪前移放置木块
